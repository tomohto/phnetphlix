...
Movie::Movie(const string& id, const string& title, const string& release_year,
             ...
             const vector<string>& genres, float rating):m_id(id),m_title(title),m_year(release_year),m_directors(directors),m_actors(actors),m_genres(genres),m_rating(rating){};
